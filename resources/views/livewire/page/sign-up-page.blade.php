    ...
    <form class="w-full flex flex-col gap-4">
        <div class="flex flex-col gap-1" x-data="{focused: false, content: ''}">
            <label class="relative flex items-center">
                <input @focus="focused = true" @blur="focused = false" x-model="content" inputmode="email" type="text"
                       class="w-full pl-10 pr-4 py-2 rounded-lg
                                    ...
                                    placeholder:text-secondary-600" placeholder="Enter your display name">
            ...
            <label class="relative flex items-center">
                <input @focus="focused = true" @blur="focused = false" x-model="content" inputmode="email" type="text"
                       class="w-full pl-10 pr-4 py-2 rounded-lg
                                    ...
                                    text-white bg-secondary-800
                                    border-secondary-700 focus:border-primary-600
                                    placeholder:text-secondary-600" placeholder="Enter your username">
        ...
        <button class="uppercase animate bg-secondary-900 border hover:bg-secondary-800 border-secondary-800 rounded-lg px-4 py-2 text-white">
            Sign up
        </button>

        <p class="text-secondary-400 text-sm">
            Have an account?
            <a href="{{ route('page.login') }}" wire:navigate class="text-white underline">
                Login
            </a>
        </p>
    </form>
